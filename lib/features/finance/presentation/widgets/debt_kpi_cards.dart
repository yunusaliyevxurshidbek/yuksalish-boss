...
/// Horizontally scrollable debt KPI cards
class DebtKpiCards extends StatelessWidget {
  const DebtKpiCards({
    super.key,
    required this.stats,
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: ListView(
        ...
        children: [
          _KpiCard(
            title: 'finance_total_debt_kpi'.tr(),
            value: stats.formattedTotalDebt,
            subtitle: 'finance_debtors_count_kpi'.tr(args: ['${stats.debtorsCount}']),
          ...
          _KpiCard(
            ...
            value: stats.formattedOverdueAmount,
          ...
          SizedBox(width: AppSizes.p12.w),
          _KpiCard(
            title: "finance_paid_this_month".tr(),
            value: stats.formattedPaidThisMonth,
            subtitle: 'UZS',
          ...
          SizedBox(width: AppSizes.p12.w),
          _KpiCard(
            title: 'finance_active_contracts'.tr(),
            value: '${stats.activeCount}',
            subtitle: 'finance_contracts_unit'.tr(args: ['${stats.activeCount}']),
